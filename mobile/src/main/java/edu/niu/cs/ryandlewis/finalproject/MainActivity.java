...
/**
 * VR Driver program based largely on code from Google's VR sdk-treasurehunt sample application,
 * with added MessageClient code
*/
public class MainActivity extends GvrActivity implements MessageClient.OnMessageReceivedListener, GvrView.StereoRenderer {

    protected float[] modelCube;
    protected float[] modelPosition;

    private static final String TAG = "Cardboard Remote Activity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Register our Wearable Client Listener so we can receive a message when the watch button is pressed
        Wearable.getMessageClient(this).addListener(this);
    }


    /**
    * Triggers when the button is pressed on the Watch
    */
    @Override
    ...
    public void onCardboardTrigger() {
        ...
        if (isLookingAtObject()) {
            int successSourceId = gvrAudioEngine.createStereoSound(SUCCESS_SOUND_FILE);
